...
import kasandraHeadshot from "@/assets/kasandra/black-dress-professional.webp";
import KasandraPortrait from "@/components/v2/KasandraPortrait";
import kasandraLifestyle from "@/assets/kasandra/desert-garden-closeup.webp";
      ...
      <section className="bg-white py-16 md:py-20">
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <div className="space-y-6 text-cc-charcoal/80 leading-relaxed text-[17px]">
            ...
            <p>
              {t(
                "I started this career at 35. Some people thought I was late. I think I was right on time. By 42, I've guided over 100 families through one of the biggest decisions of their lives — earned the Luxury Property Specialist designation, a 5-star average across 126+ reviews, and now lead my own team brand at Corner Connect, brokered by Realty Executives Arizona Territory. But the credential I'm most proud of? The families who call me back for their second, third, or fourth transaction.",
                "Comencé esta carrera a los 35. Algunas personas pensaron que era tarde. Yo creo que fue justo a tiempo. A los 42, he guiado a más de 100 familias a través de una de las decisiones más grandes de sus vidas — gané la designación de Especialista en Propiedades de Lujo, un promedio de 5 estrellas en más de 126 reseñas, y ahora dirijo mi propia marca de equipo en Corner Connect, bajo la correduría de Realty Executives Arizona Territory. ¿Pero la credencial de la que más me enorgullezco? Las familias que me llaman de nuevo para su segunda, tercera o cuarta transacción."
              )}
            </p>
          </div>
        </div>
