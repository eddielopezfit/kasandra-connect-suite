    ...
    sections: [
      {
        ...
        headingEs: "Paso 1: Evalúa Tu Preparación Financiera",
        ...
        contentEs: "Antes de explorar listados, es útil entender tu punto de partida financiero.\n\nComienza revisando tu perfil crediticio. Muchos préstamos convencionales buscan puntajes de 620 o más, mientras que los préstamos FHA pueden permitir puntajes más bajos. Luego, calcula tu relación deuda-ingreso (DTI)—tus pagos mensuales totales de deuda divididos por tu ingreso mensual bruto. En muchos casos, los prestamistas buscan un DTI por debajo del 43%.\n\nTambién querrás planificar para:\n• Un pago inicial (generalmente entre 3–20%, dependiendo del tipo de préstamo)\n• Costos de cierre (típicamente 2–5% del monto del préstamo)\n• Gastos de mudanza y mantenimiento inicial del hogar\n\nEste paso no se trata de perfección—se trata de consciencia.",
      },
      {
        heading: "Step 2: Get Pre-Approved for a Mortgage",
        headingEs: "Paso 2: Obtén Pre-Aprobación para una Hipoteca",
        ...
        contentEs: "Una pre-aprobación hipotecaria te ayuda a entender qué rango de precio podría tener sentido y muestra a los vendedores que estás financieramente preparado.\n\nDurante la pre-aprobación, un prestamista revisa tus ingresos, activos, deudas e historial crediticio para determinar un monto de préstamo. Es buena idea comparar opciones con dos o tres prestamistas para entender tasas, términos y expectativas de pagos mensuales.\n\nLas pre-aprobaciones generalmente son válidas por 60–90 días. Ten en cuenta: calificar para cierta cantidad no significa que debas usar el monto completo. La comodidad y la estabilidad a largo plazo importan.",
      },
      {
        heading: "Step 3: Choose the Right Real Estate Professional",
        headingEs: "Paso 3: Elige al Profesional Inmobiliario Adecuado",
      ...
      },
      {
        ...
        contentEs: "Antes de recorrer casas, crea una lista simple de:\n• Imprescindibles (no negociables)\n• Deseables (características flexibles)\n\nMientras exploras, considera factores prácticos como tiempos de viaje, distribución del vecindario y acceso a amenidades cotidianas. Visitar casas en diferentes momentos del día puede ofrecer perspectiva útil.\n\nToma notas y fotos—después de varias visitas, los detalles pueden mezclarse. Tu objetivo no es apresurarte, sino reconocer cuando una casa se alinea con tus prioridades.",
      },
      {
        ...
        contentEs: "Cuando estés listo para hacer una oferta, varios elementos entran en juego:\n• Precio de compra\n• Depósito de arras\n• Contingencias (financiamiento, inspección, avalúo)\n• Cronograma de cierre propuesto\n\nEn mercados competitivos, el tiempo y la estructura importan. Tu agente te ayudará a entender las opciones y presentar una oferta alineada con las condiciones actuales. Hasta que todo esté finalizado, es mejor mantener los pies en la tierra—las transacciones inmobiliarias tienen múltiples puntos de control.",
      },
      {
      ...
      },
      {
        ...
        contentEs: "El día de cierre involucra firmar documentos, confirmar fondos y completar la compra.\n\nTu prestamista y compañía de títulos te guiarán a través de cada formulario. Tómate el tiempo para revisar todo cuidadosamente. Una vez que la transacción se registre, recibirás las llaves de tu nueva casa.\n\nDespués del cierre, enfócate en los siguientes pasos prácticos—configurar servicios, cambiar cerraduras y acomodarte en tu espacio.\n\nBienvenido a casa.",
      },
      {
        heading: "What's Next?",
        headingEs: "¿Qué Sigue?",
        ...
        contentEs: "Si estás listo para explorar opciones que se ajusten a tu situación—o si simplemente te gustaría claridad sobre por dónde empezar—eres bienvenido a dar el siguiente paso a tu propio ritmo.\n\nNo hay presión. Solo apoyo cuando estés listo.",
      },
    ],
  },
