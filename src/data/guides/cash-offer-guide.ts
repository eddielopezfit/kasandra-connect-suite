      ...
      faqItems: [
        {
          ...
          answer: "Real talk: cash offers come in lower — and that's not a secret. In Tucson, they typically run 80–90% of market value depending on condition and location. What you're trading is price for certainty. Traditional listings in Pima County are closing at about 97.64% of list price right now, but that comes with 38+ days on market, showings, repairs, and the real risk of a buyer's financing falling through at the last minute. Some sellers would trade that difference for peace of mind in a heartbeat. Others wouldn't. I'll help you run the real numbers so you can make the call that's right for you.",
          answerEs: "La verdad es: las ofertas en efectivo llegan más bajas — y eso no es un secreto. En Tucson, típicamente van al 80–90% del valor de mercado según condición y ubicación. Lo que está intercambiando es precio por certeza. Las ventas tradicionales en Pima County están cerrando alrededor del 97.64% del precio de lista ahora mismo, pero eso viene con 38+ días en el mercado, visitas, reparaciones y el riesgo real de que el financiamiento del comprador falle al final. Algunos vendedores cambiarían esa diferencia por tranquilidad sin pensarlo. Otros no. Le ayudaré a calcular los números reales para que pueda tomar la decisión correcta para usted.",
        },
        {
          ...
          answer: "Faster than most people expect — usually 7 to 21 days from accepted offer. Because there's no lender involved, there's no appraisal wait, no underwriting, no loan conditions holding things up. The title company handles escrow and that's essentially it. I've walked clients from 'I need to sell' to 'keys are out of my hands' in under two weeks. If you're facing a relocation deadline, an estate situation, or you just need certainty on a timeline — a cash offer can make that possible in a way a traditional listing simply can't.",
          answerEs: "Más rápido de lo que la mayoría espera — normalmente 7 a 21 días desde la oferta aceptada. Como no hay un prestamista involucrado, no hay espera de tasación, ni suscripción, ni condiciones de préstamo que retrasen las cosas. La compañía de títulos maneja el fideicomiso y eso es básicamente todo. He acompañado clientes de 'necesito vender' a 'las llaves ya no son mías' en menos de dos semanas.",
        },
        {
          ...
          answer: "With a direct cash buyer, typically no — and that's one of the things that makes the net closer than people expect. Not paying 5–6% commission changes the math significantly. Closing costs (title fees, transfer taxes) still apply, but they're usually lower than in a traditional sale too. What I always tell people: get it confirmed in writing before you sign anything, and let me run a side-by-side net sheet so you can see exactly what you'd walk away with under each path.",
          answerEs: "Con un comprador directo en efectivo, típicamente no — y eso es lo que hace que los ingresos netos sean más cercanos de lo que la gente espera. No pagar comisión del 5–6% cambia significativamente los números. Los costos de cierre (tarifas de título, impuestos de transferencia) aún aplican, pero también suelen ser más bajos que en una venta tradicional. Lo que siempre le digo a la gente: confírmelo por escrito antes de firmar nada.",
        },
        {
          ...
          answer: "Yes — and honestly, this is exactly what cash offers were designed for. Cash buyers in Tucson purchase homes as-is, in any condition. The roof, the HVAC, the kitchen that hasn't been touched since 1987 — none of it disqualifies you. The offer reflects the repair costs, but you skip the stress of managing contractors, spending money before you've sold, and hoping the work gets done in time. For a lot of people dealing with a property that needs work, this is the path that actually makes the situation manageable.",
          answerEs: "Sí — y honestamente, esto es exactamente para lo que se diseñaron las ofertas en efectivo. Los compradores en efectivo en Tucson compran casas en su estado actual, en cualquier condición. El techo, el HVAC, la cocina que no se ha tocado desde 1987 — nada de eso lo descalifica. La oferta refleja los costos de reparación, pero usted se salta el estrés de gestionar contratistas y gastar dinero antes de haber vendido.",
        },
        {
          question: "Is a cash offer legitimate or is it a scam?",
          questionEs: "¿Es legítima una oferta en efectivo o es una estafa?",
          answer: "Legitimate ones exist — and so do predatory ones, so this is worth knowing. Any real cash transaction closes through a licensed Arizona title company. If someone is pressuring you to skip the title company, wire money before closing, or sign something without time to read it — that's your signal to walk away. Offers that come in unusually high are often bait-and-switch situations. I work with vetted local investors and can help you evaluate any offer you receive before you commit to anything. You should never feel rushed or confused at this stage.",
          answerEs: "Las legítimas existen — y también las predatorias, así que vale la pena saberlo. Cualquier transacción real en efectivo cierra a través de una compañía de títulos de Arizona licenciada. Si alguien te presiona a omitir la compañía de títulos, transferir dinero antes del cierre, o firmar algo sin tiempo para leerlo — esa es tu señal de alejarte. Trabajo con inversores locales verificados y puedo ayudarte a evaluar cualquier oferta que recibas antes de comprometerte con nada.",
        },
      ],
    },
  ],
