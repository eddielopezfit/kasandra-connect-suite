...
const data: GuideContentData = {
    ...
    },
    {
      ...
      faqItems: [
        ...
        },
        {
          ...
          answer: "I get this question constantly, and I want to give you an honest answer rather than a sales pitch. Tucson's median price is around $365,000 right now (March 2026) with rates in the mid-6% range. There's no clear signal that prices will drop significantly in Pima County — 4.92 months of supply puts us in a roughly balanced market. Here's what I actually tell people: the question isn't really about timing. It's about readiness. If you can qualify, you plan to stay 3+ years, and the payment fits your life — buying now builds equity. If rates drop later, you refinance. What you can't get back is the time you spent waiting.",
          answerEs: "Recibo esta pregunta constantemente, y quiero darle una respuesta honesta en lugar de un argumento de ventas. El precio medio de Tucson es alrededor de $365,000 ahora mismo (marzo 2026) con tasas en el rango del 6% medio. No hay señal clara de que los precios caigan significativamente en el Condado de Pima. Lo que realmente le digo a la gente: la pregunta no es realmente sobre el momento. Es sobre la preparación. Si puede calificar, planea quedarse 3+ años, y el pago encaja en su vida — comprar ahora acumula patrimonio. Si las tasas bajan después, refinancia.",
        },
      ],
    },
  ],
  ...
  externalLinks: [
    ...
    },
    {
      ...
      labelEs: 'Límites de Préstamos FHA — HUD.gov',
      url: 'https://www.hud.gov/program_offices/housing/sfh/lender/origination/mortgage_limits',
      description: 'Verify current FHA loan limits for Pima County directly from HUD.',
      descriptionEs: 'Verifique los límites actuales del préstamo FHA para el Condado de Pima directamente de HUD.',
    },
  ],
};
