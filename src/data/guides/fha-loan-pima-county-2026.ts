      ...
      faqItems: [
        {
          ...
          answer: 'The 2026 FHA loan limit for a single-family home in Pima County is $498,257. This covers the vast majority of homes in the Tucson market, where the median price is approximately $365,000. If the home you want is priced above $498,257, you would need to explore conventional financing or a jumbo loan.',
          answerEs: 'El límite del préstamo FHA de 2026 para una casa unifamiliar en el Condado de Pima es $498,257. Esto cubre la gran mayoría de las casas en el mercado de Tucson, donde el precio medio es aproximadamente $365,000.',
        },
        {
