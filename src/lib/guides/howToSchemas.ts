  ...
  'cost-to-sell-tucson': {
    ...
    steps: [
      ...
      },
      {
        ...
        text: "Add commission + closing costs + prep + holding costs, then subtract from sale price. Also subtract your mortgage payoff balance. The result is your estimated net proceeds. Use Kasandra's Seller Net Calculator at text: "Add commission + closing costs + prep + holding costs, then subtract from sale price. Also subtract your mortgage payoff balance. The result is your estimated net proceeds. Use Kasandra's Seller Net Calculator at kasandraprietorealtor.com to run your specific numbers.", to run your specific numbers.",
