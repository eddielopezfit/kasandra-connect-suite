...
export const getLiveGuides = (): GuideRegistryEntry[] => {
...

  {
    ...
    description: 'The full breakdown — commission, closing costs, prep, holding costs, and what you actually walk away with.',
    ...
    decisionIntent: 'sell',
    funnelStage: 'mofu',
    keywords: ['cost to sell', 'how much does it cost', 'closing costs', 'commission', 'net proceeds', 'what do I walk away with', 'cuánto cuesta vender', 'costos de venta'],
    tier: 1,
    lifeEvent: 'general_selling',
    destinations: {
...

  {
    ...
    description: 'Every term you'll encounter — SPDS, BINSR, earnest money, deed of trust, contingency — explained in plain English.',
    ...
    decisionIntent: 'buy',
    funnelStage: 'tofu',
    keywords: ['glossary', 'terms', 'SPDS', 'BINSR', 'earnest money', 'escrow', 'contingency', 'deed of trust', 'glosario', 'términos', 'dinero en serio', 'fideicomiso'],
    tier: 2,
...

  {
    ...
    title: 'Marana vs. Oro Valley vs. Sahuarita vs. Vail',
    titleEs: 'Marana vs. Oro Valley vs. Sahuarita vs. Vail',
    description: 'The honest side-by-side: schools, prices, commutes, and who each suburb is actually right for.',
    ...
    decisionIntent: 'buy',
    funnelStage: 'tofu',
    keywords: ['marana', 'oro valley', 'sahuarita', 'vail', 'rita ranch', 'tucson suburbs', 'best suburb', 'compare neighborhoods', 'suburbios de tucson', 'mejor suburbio'],
    tier: 1,
    lifeEvent: 'relocation_buying',
    destinations: {
...

  {
    ...
    description: 'HOME Plus, Pathway to Purchase, Pima Tucson Homebuyer's Solution, FHA, VA, USDA — what's available and who qualifies.',
    ...
    decisionIntent: 'buy',
    funnelStage: 'tofu',
    keywords: ['first time buyer programs', 'down payment assistance', 'HOME Plus', 'FHA loan', 'USDA loan', 'buyer assistance arizona', 'programas compradores primerizos', 'asistencia pago inicial'],
    tier: 1,
    lifeEvent: 'first_time_buyer',
    destinations: {
...

  {
    ...
    description: 'The $250K/$500K exclusion, Arizona's flat tax, cost basis, and when you actually owe — explained clearly.',
    ...
    decisionIntent: 'sell',
    funnelStage: 'mofu',
    keywords: ['capital gains', 'capital gains tax', 'tax when selling home', 'section 121', 'exclusion', 'arizona home sale tax', 'ganancias de capital', 'impuesto venta casa'],
    tier: 2,
    lifeEvent: 'general_selling',
    destinations: {
...

  {
    ...
    description: 'The cash flow framework, the capital gains window, and how to make the right call for your specific situation.',
    ...
    decisionIntent: 'sell',
    funnelStage: 'mofu',
    keywords: ['sell or rent', 'rent vs sell', 'should I rent my house', 'landlord', 'cash flow', 'vender o alquilar', 'arrendar mi casa', 'flujo de efectivo'],
    tier: 2,
    lifeEvent: 'general_selling',
    destinations: {
...

  {
    ...
    description: 'Current Tucson timeline data, what speeds it up, what slows it down — by price range and season.',
    ...
    decisionIntent: 'sell',
    funnelStage: 'tofu',
    keywords: ['how long to sell', 'days on market', 'timeline selling', 'how fast', 'cuánto tiempo vender', 'días en el mercado', 'cronograma venta'],
    tier: 2,
    lifeEvent: 'general_selling',
    destinations: {
...

  {
    ...
    description: 'What's available by immigration status — green card, visa, DACA, and ITIN loans. The honest guide.',
    ...
    decisionIntent: 'buy',
    funnelStage: 'tofu',
    keywords: ['non citizen', 'DACA', 'ITIN loan', 'green card', 'visa', 'undocumented', 'immigrant homebuyer', 'no ciudadano', 'comprar casa sin ciudadanía', 'préstamo ITIN'],
    tier: 1,
    lifeEvent: 'first_time_buyer',
    destinations: {
