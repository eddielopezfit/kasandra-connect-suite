...
export const GUIDE_REGISTRY: GuideRegistryEntry[] = [
  ...
  {
    id: 'itin-loan-guide',
    path: '/guides/itin-loan-guide',
    titleEn: 'Buying a Home in Tucson with an ITIN Loan (No SSN Required)',
    titleEs: 'Comprar una Casa en Tucson con un Préstamo ITIN (Sin Número de Seguro Social)',
    labelEn: 'ITIN Loan Guide',
    labelEs: 'Guía de Préstamos ITIN',
    descriptionEn: 'How to buy a home in Tucson without a Social Security number. ITIN loans, documentation requirements, credit building, and lenders who specialize in non-SSN borrowers.',
    descriptionEs: 'Cómo comprar una casa en Tucson sin número de Seguro Social. Préstamos ITIN, requisitos de documentación, construcción de crédito y prestamistas especializados.',
    readTime: '10 min read',
    readTimeEs: '10 min de lectura',
    isFeatured: true,
    category: 'buying',
    ...
    destinations: {
      ...
      relatedGuideIds: ['buying-home-noncitizen-arizona', 'first-time-buyer-guide', 'down-payment-assistance-tucson'],
    },
    decisionIntent: 'buy',
    decisionStage: 'explore',
    sortOrder: 46,
  ...
  {
    id: 'tucson-market-update-2026',
    path: '/guides/tucson-market-update-2026',
    titleEn: 'Tucson Real Estate Market Update: March 2026',
    titleEs: 'Actualización del Mercado Inmobiliario de Tucson: Marzo 2026',
    labelEn: 'Market Update March 2026',
    labelEs: 'Actualización de Mercado Marzo 2026',
    descriptionEn: 'Current Tucson housing market conditions — prices, days on market, inventory, rate outlook, and what it means for buyers and sellers right now.',
    descriptionEs: 'Condiciones actuales del mercado inmobiliario de Tucson — precios, días en mercado, inventario, perspectiva de tasas y lo que significa para compradores y vendedores ahora.',
    readTime: '8 min read',
    readTimeEs: '8 min de lectura',
    isFeatured: true,
    category: 'selling',
    ...
    destinations: {
      ...
      relatedGuideIds: ['selling-for-top-dollar', 'first-time-buyer-guide', 'tucson-neighborhoods'],
    },
    decisionIntent: 'sell',
    decisionStage: 'explore',
    sortOrder: 47,
  ...
  // --- bad-credit-home-buying-tucson ---
  {
    ...
    titleEn: 'Buying a Home in Tucson with Bad Credit: What Actually Works',
    titleEs: 'Comprar una Casa en Tucson con Mal Crédito: Lo Que Realmente Funciona',
    labelEn: 'Bad Credit Home Buying Guide',
    labelEs: 'Guía de Compra con Mal Crédito',
    descriptionEn: 'Low credit score options in Tucson — FHA minimums, credit repair strategies, ITIN alternatives, and when to push through vs. when to wait and rebuild.',
    descriptionEs: 'Opciones de puntaje de crédito bajo en Tucson — mínimos FHA, estrategias de reparación crediticia, alternativas ITIN y cuándo avanzar vs. cuándo esperar y reconstruir.',
    readTime: '9 min read',
    readTimeEs: '9 min de lectura',
    isFeatured: false,
    category: 'buying',
  ...
  {
    id: 'down-payment-assistance-tucson',
    path: '/guides/down-payment-assistance-tucson',
    titleEn: 'Down Payment Assistance Programs in Tucson, Arizona (2026)',
    titleEs: 'Programas de Asistencia para el Pago Inicial en Tucson, Arizona (2026)',
    labelEn: 'Down Payment Assistance Tucson',
    labelEs: 'Asistencia para Pago Inicial en Tucson',
    descriptionEn: 'All active DPA programs in Pima County — PTHS, HOME, Lighthouse, and more. Who qualifies, how to stack programs, and how to get started.',
    descriptionEs: 'Todos los programas DPA activos en el Condado de Pima — PTHS, HOME, Lighthouse y más. Quién califica, cómo combinar programas y cómo comenzar.',
    readTime: '10 min read',
    readTimeEs: '10 min de lectura',
    isFeatured: true,
    category: 'buying',
    ...
    destinations: {
      ...
      relatedGuideIds: ['first-time-buyer-guide', 'fha-loan-pima-county-2026', 'bad-credit-home-buying-tucson'],
    },
    decisionIntent: 'buy',
    decisionStage: 'explore',
    sortOrder: 49,
  ...
  // --- fha-loan-pima-county-2026 ---
  {
    ...
    titleEn: 'FHA Loan Limits in Pima County 2026: What Every Tucson Buyer Needs to Know',
    titleEs: 'Límites de Préstamos FHA en el Condado de Pima 2026: Lo Que Todo Comprador de Tucson Necesita Saber',
    labelEn: 'FHA Loans Pima County 2026',
    labelEs: 'Préstamos FHA Condado de Pima 2026',
    descriptionEn: '2026 FHA loan limits for Pima County, how FHA works, FHA vs conventional comparison, and how to combine FHA with local down payment assistance programs.',
    descriptionEs: 'Límites de préstamos FHA 2026 para el Condado de Pima, cómo funciona FHA, comparación FHA vs convencional y cómo combinar FHA con programas locales de asistencia para pago inicial.',
    readTime: '10 min read',
    readTimeEs: '10 min de lectura',
    isFeatured: false,
    category: 'buying',
    ...
    destinations: {
      ...
      relatedGuideIds: ['first-time-buyer-guide', 'down-payment-assistance-tucson', 'buying-home-noncitizen-arizona'],
    },
    decisionIntent: 'buy',
    decisionStage: 'explore',
    sortOrder: 50,
  ...
  // === GHOST GUIDES: Had data loaders but no registry entry (audit fix 2026-03-15) ===
  {
    id: 'va-home-loan-tucson',
    path: '/guides/va-home-loan-tucson',
    titleEn: 'VA Home Loan in Tucson: The Complete Guide for Veterans and Active Duty',
    titleEs: 'Préstamo Hipotecario VA en Tucson: La Guía Completa para Veteranos y Servicio Activo',
    labelEn: 'VA Home Loan Guide',
    labelEs: 'Guía de Préstamo VA',
    descriptionEn: 'Everything veterans and active-duty service members near Davis-Monthan AFB need to know to use their VA home loan benefit in Tucson — zero down, no PMI, and 2026 Pima County loan limits.',
    descriptionEs: 'Todo lo que veteranos y militares en servicio activo cerca de la Base Davis-Monthan necesitan saber para usar su beneficio de préstamo VA en Tucson — cero inicial, sin PMI y límites 2026.',
    readTime: '12 min read',
    readTimeEs: '12 min de lectura',
    isFeatured: false,
    category: 'military',
    status: 'live',
    funnelStage: 'tofu',
    keywords: ['va', 'veteran', 'military', 'davis-monthan', 'dmafb', 'va loan', 'zero down', 'no pmi', 'veterano', 'militar', 'préstamo va'],
    tier: 1,
    lifeEvent: 'military_va_purchase',
    assetSlots: { disclaimer: 'financial' },
    destinations: {
  ...
  },
  {
    ...
    path: '/guides/divorce-home-sale-arizona',
    titleEn: 'Selling a Home During Divorce in Arizona: What You Need to Know',
    titleEs: 'Vender una Casa Durante el Divorcio en Arizona: Lo Que Necesitas Saber',
    labelEn: 'Divorce Home Sale Guide',
    labelEs: 'Guía de Venta en Divorcio',
    descriptionEn: "Arizona's community property laws, the three paths forward (sell, buyout, co-own), and how to navigate the sale process when both spouses must agree — explained clearly.",
    descriptionEs: 'Las leyes de propiedad comunitaria de Arizona, los tres caminos posibles (vender, comprar, co-poseer) y cómo navegar el proceso de venta cuando ambos cónyuges deben estar de acuerdo.',
    readTime: '10 min read',
    readTimeEs: '10 min de lectura',
    isFeatured: false,
    category: 'divorce',
    status: 'live',
    funnelStage: 'tofu',
    keywords: ['divorce', 'divorcio', 'separation', 'separación', 'community property', 'propiedad comunitaria', 'arizona divorce', 'marital home'],
    tier: 1,
    lifeEvent: 'divorce_home_sale',
    assetSlots: { disclaimer: 'legal' },
    destinations: {
      primaryAction: { type: 'open_chat', payload: { source: 'guide', guideId: 'divorce-home-sale-arizona', lifeEvent: 'divorce_home_sale' }, label: { en: 'Talk through my situation', es: 'Hablar sobre mi situación' } },
      secondaryActions: [
        { type: 'open_chat', payload: { source: 'guide', guideId: 'divorce-home-sale-arizona', lifeEvent: 'divorce_home_sale' }, label: { en: 'Book a private consultation', es: 'Reservar una consulta privada' } },
      ],
      relatedGuideIds: ['divorce-selling', 'selling-for-top-dollar', 'cash-offer-guide'],
    },
    decisionIntent: 'sell',
    decisionStage: 'explore',
    sortOrder: 36,
  ...
  },
  {
    ...
    path: '/guides/first-time-buyer-programs-pima-county',
    titleEn: 'First-Time Home Buyer Programs in Pima County 2026: The Complete Guide',
    titleEs: 'Programas para Compradores de Primera Vivienda en el Condado de Pima 2026: La Guía Completa',
    labelEn: 'Pima County Buyer Programs',
    labelEs: 'Programas para Compradores Pima',
    descriptionEn: 'Every active down payment assistance and first-time buyer program available in Pima County in 2026 — PTHS, HOME Plus, ADOH, USDA — income limits, how to stack them, and how to apply.',
    descriptionEs: 'Cada programa activo de asistencia para el pago inicial disponible en el Condado de Pima en 2026 — PTHS, HOME Plus, ADOH, USDA — límites de ingresos, cómo combinarlos y cómo aplicar.',
    readTime: '11 min read',
    readTimeEs: '11 min de lectura',
    isFeatured: false,
    category: 'buying',
    status: 'live',
    funnelStage: 'tofu',
    keywords: ['first time buyer', 'down payment assistance', 'dpa', 'pima county', 'pths', 'home plus', 'adoh', 'programs', 'compradores primerizos', 'asistencia'],
    tier: 1,
    lifeEvent: 'first_time_buying',
    assetSlots: { disclaimer: 'financial' },
    destinations: {
