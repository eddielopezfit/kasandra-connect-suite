...
export const CHIPS_REGISTRY: readonly ChipRegistryEntry[] = [
  ...
  // --- Tool: buyer readiness ---
  {
    ...
    actionSpec: { type: 'open_tool', toolId: 'buyer-readiness', label: { en: 'Take the readiness check', es: 'Evaluación de preparación' } },
  ...
  },
  {
    ...
    label_en: 'Quick seller readiness check',
    label_es: 'Preparación para vender',
    normalized_key: 'preparacion para vender',
    actionSpec: { type: 'open_tool', toolId: 'seller-readiness', label: { en: 'Quick seller readiness check', es: 'Preparación para vender' } },
    chipKey: CHIP_KEYS.SELLER_READINESS,
  },
  ...
  },
  {
    ...
    label_en: 'Non-Citizen Buyers',
    label_es: 'Guía No Ciudadanos',
    normalized_key: 'non-citizen buyers',
    actionSpec: { type: 'open_guide', guideId: 'buying-home-noncitizen-arizona', label: { en: 'Non-Citizen Buyers', es: 'Guía No Ciudadanos' } },
  },
  {
    id: 'guide-noncitizen-es',
    label_en: 'Non-Citizen Buyers',
    label_es: 'Guía No Ciudadanos',
    normalized_key: 'guia no ciudadanos',
    actionSpec: { type: 'open_guide', guideId: 'buying-home-noncitizen-arizona', label: { en: 'Non-Citizen Buyers', es: 'Guía No Ciudadanos' } },
  },
  {
  ...
  // --- Market Intelligence ---
  {
    ...
    actionSpec: { type: 'navigate', path: '/market', label: { en: 'Tucson Market Data', es: 'Datos del Mercado Tucson' } },
  },
  {
  ...
  // --- Neighborhood Compare ---
  {
    ...
    actionSpec: { type: 'navigate', path: '/neighborhood-compare', label: { en: 'Compare Neighborhoods', es: 'Comparar Vecindarios' } },
  },
  {
  ...
  // --- Buyer Closing Costs ---
  {
    ...
    actionSpec: { type: 'navigate', path: '/buyer-closing-costs', label: { en: 'Estimate Closing Costs', es: 'Estimar Costos de Cierre' } },
  },
  {
  ...
  },
  {
    ...
    actionSpec: { type: 'message', label: { en: 'ASAP (0–30 days)', es: 'Lo antes posible (0–30 días)' } },
  },
  {
    ...
    actionSpec: { type: 'message', label: { en: '1–3 months', es: '1–3 meses' } },
  },
  {
    ...
    actionSpec: { type: 'message', label: { en: '3–6 months', es: '3–6 meses' } },
  },
  {
    ...
    actionSpec: { type: 'message', label: { en: 'Just exploring', es: 'Solo explorando' } },
  },
] as const;
