...
export const TOOL_BRIDGES: Record<string, ToolBridgeConfig> = {
  ...
  'senior-downsizing': {
    icon: 'calculator',
    eyebrowEn: 'Know What Your Home Is Worth Before You Move',
    eyebrowEs: 'Conoce el Valor de Tu Casa Antes de Mudarte',
    headlineEn: 'What Would You Net From the Sale of Your Current Home?',
    headlineEs: '¿Cuánto Netearías con la Venta de Tu Casa Actual?',
    bodyEn: 'Downsizing starts with one number: what you walk away with. Your mortgage payoff, your estimated value, and your closing costs — calculated side by side in under 2 minutes.',
    bodyEs: 'Reducir el tamaño comienza con un número: con lo que te quedas. Tu saldo hipotecario, tu valor estimado y tus costos de cierre — calculado lado a lado en menos de 2 minutos.',
    ctaLabelEn: 'Run My Seller Net Sheet',
    ctaLabelEs: 'Calcular Mi Hoja de Neto',
    ctaPath: '/v2/cash-offer-options',
    secondaryLabelEn: 'Explore Tucson 55+ neighborhoods',
    secondaryLabelEs: 'Explorar vecindarios 55+ en Tucson',
    secondaryPath: '/v2/neighborhood-compare',
  },
  'move-up-buyer': {
    icon: 'calculator',
    eyebrowEn: 'Your Equity Is the Key',
    eyebrowEs: 'Tu Capital Es la Clave',
    headlineEn: 'How Much Equity Do You Actually Have to Work With?',
    headlineEs: '¿Con Cuánto Capital Cuentas Realmente?',
    bodyEn: 'The move-up math depends on your current net proceeds. Run the seller side first — what you walk away with determines what you can put down on the next home.',
    bodyEs: 'La matemática de la mejora depende de tus ganancias netas actuales. Ejecuta primero el lado vendedor — lo que te quedas determina lo que puedes poner de entrada en la próxima casa.',
    ctaLabelEn: 'Calculate My Seller Net',
    ctaLabelEs: 'Calcular Mi Neto de Vendedor',
    ctaPath: '/v2/cash-offer-options',
    secondaryLabelEn: 'Take the seller readiness check',
    secondaryLabelEs: 'Tomar el cuestionario de preparación del vendedor',
    secondaryPath: '/v2/seller-readiness',
  },
  'sell-or-rent-tucson': {
    icon: 'chart',
    eyebrowEn: 'Not Sure Which Way to Go?',
    eyebrowEs: '¿No Estás Seguro de Qué Camino Tomar?',
    headlineEn: 'The Decision Wizard Can Map Your Situation in 5 Questions',
    headlineEs: 'El Asistente de Decisión Puede Mapear Tu Situación en 5 Preguntas',
    bodyEn: 'Timeline pressure, financial readiness, and market conditions all factor in. The Seller Decision Wizard helps you see your real options — without pressure.',
    bodyEs: 'La presión del tiempo, la preparación financiera y las condiciones del mercado son factores importantes. El Asistente de Decisión te ayuda a ver tus opciones reales — sin presión.',
    ctaLabelEn: 'Start the Decision Wizard',
    ctaLabelEs: 'Iniciar el Asistente de Decisión',
    ctaPath: '/v2/seller-decision',
    secondaryLabelEn: 'Run my seller net sheet',
  ...
  'capital-gains-home-sale-arizona': {
    icon: 'calculator',
    eyebrowEn: 'See the Full Picture Before You Decide',
    eyebrowEs: 'Ve el Panorama Completo Antes de Decidir',
    headlineEn: 'What Do You Actually Walk Away With After Taxes and Costs?',
    headlineEs: '¿Con Qué Te Quedas Realmente Después de Impuestos y Costos?',
    bodyEn: 'Capital gains considerations are one piece. The other is your net proceeds — after commission, closing costs, and your mortgage payoff. Run the real number.',
    bodyEs: 'Las consideraciones de ganancias de capital son una parte. La otra son tus ganancias netas — después de comisión, costos de cierre y tu saldo hipotecario. Calcula el número real.',
    ctaLabelEn: 'Run My Seller Net Sheet',
    ctaLabelEs: 'Calcular Mi Hoja de Neto',
    ctaPath: '/v2/cash-offer-options',
    secondaryLabelEn: 'Talk through my tax situation',
    secondaryLabelEs: 'Hablar sobre mi situación fiscal',
    secondaryPath: '/v2/sell',
  },
  'buying-home-noncitizen-arizona': {
    icon: 'compass',
    eyebrowEn: 'Find Out Where You Stand',
    eyebrowEs: 'Averigua Dónde Estás Parado',
    headlineEn: 'What Is Your Realistic Starting Point as a Buyer Right Now?',
    headlineEs: '¿Cuál Es Tu Punto de Partida Realista como Comprador Ahora Mismo?',
    bodyEn: 'Pre-approval path, down payment, timeline — the Buyer Readiness check gives you a personalized next step based on your actual situation, immigration status included.',
    bodyEs: 'Camino de preaprobación, pago inicial, cronograma — la verificación de Preparación del Comprador te da un próximo paso personalizado basado en tu situación real, incluyendo tu estatus migratorio.',
    ctaLabelEn: 'Check My Buyer Readiness',
    ctaLabelEs: 'Verificar Mi Preparación como Comprador',
    ctaPath: '/v2/buyer-readiness',
    secondaryLabelEn: 'Estimate my closing costs',
  ...
  'tucson-suburb-comparison': {
    icon: 'map',
    eyebrowEn: 'Compare Any Two ZIP Codes Side by Side',
    eyebrowEs: 'Compara Cualquier Dos Códigos Postales Lado a Lado',
    headlineEn: 'Which Tucson Suburb Actually Fits Your Life?',
    headlineEs: '¿Qué Suburbio de Tucson Se Adapta Realmente a Tu Vida?',
    bodyEn: 'The profiles above give you the lay of the land. Now enter 2-3 specific ZIP codes and get a real comparison — lifestyle, commute, buyer fit, and what Kasandra knows firsthand.',
    bodyEs: 'Los perfiles anteriores te dan el panorama general. Ahora ingresa 2-3 códigos postales específicos y obtén una comparación real — estilo de vida, trayecto, compatibilidad del comprador y lo que Kasandra sabe de primera mano.',
    ctaLabelEn: 'Compare Tucson Neighborhoods',
    ctaLabelEs: 'Comparar Vecindarios de Tucson',
    ctaPath: '/v2/neighborhood-compare',
    secondaryLabelEn: 'Check my buyer readiness',
  ...
  'understanding-home-valuation': {
    icon: 'calculator',
    eyebrowEn: 'Turn Curiosity Into a Real Number',
    eyebrowEs: 'Convierte la Curiosidad en un Número Real',
    headlineEn: 'What Would You Actually Net if You Sold Today?',
    headlineEs: '¿Cuánto Netearías Realmente si Vendieras Hoy?',
    bodyEn: 'Valuation is step one. The seller net sheet is step two — it shows what you keep after mortgage payoff, commission, and closing costs. Takes under 2 minutes.',
    bodyEs: 'La valoración es el paso uno. La hoja de neto del vendedor es el paso dos — muestra lo que conservas después del saldo hipotecario, comisión y costos de cierre. Menos de 2 minutos.',
    ctaLabelEn: 'Run My Seller Net Sheet',
    ctaLabelEs: 'Calcular Mi Hoja de Neto',
    ctaPath: '/v2/cash-offer-options',
    secondaryLabelEn: 'See how long it takes to sell',
    secondaryLabelEs: 'Ver cuánto tiempo toma vender',
    secondaryPath: '/v2/guides/how-long-to-sell-tucson',
  },
  'life-change-selling': {
    icon: 'compass',
    eyebrowEn: 'Get Clarity, Not More Questions',
    eyebrowEs: 'Obtén Claridad, No Más Preguntas',
    headlineEn: 'Where Are You in the Selling Decision Right Now?',
    headlineEs: '¿Dónde Estás en la Decisión de Vender Ahora Mismo?',
    bodyEn: 'Life changes create urgency and complexity at the same time. The Seller Decision Wizard asks 5 focused questions and tells you what path makes sense for your specific situation.',
    bodyEs: 'Los cambios de vida crean urgencia y complejidad al mismo tiempo. El Asistente de Decisión del Vendedor hace 5 preguntas enfocadas y te dice qué camino tiene sentido para tu situación específica.',
    ctaLabelEn: 'Start the Decision Wizard',
    ctaLabelEs: 'Iniciar el Asistente de Decisión',
    ctaPath: '/v2/seller-decision',
    secondaryLabelEn: 'Talk it through with Selena',
    secondaryLabelEs: 'Hablarlo con Selena',
    secondaryPath: '/v2/sell',
  },
  'pima-county-property-taxes': {
    icon: 'dollar',
    eyebrowEn: 'See Your Full Cost Picture',
    eyebrowEs: 'Ve Tu Panorama Completo de Costos',
    headlineEn: 'Property Taxes Are One Line Item — Here Are All the Others',
    headlineEs: 'Los Impuestos a la Propiedad Son Una Partida — Aquí Están Todas las Demás',
    bodyEn: 'Tucson closing costs include taxes, title, escrow, lender fees, and prepaid items. The closing cost estimator breaks down every line so you know exactly what to bring to the table.',
    bodyEs: 'Los costos de cierre en Tucson incluyen impuestos, título, custodia, honorarios del prestamista y artículos prepagados. El estimador de costos de cierre desglosa cada línea para que sepas exactamente qué llevar a la mesa.',
    ctaLabelEn: 'Estimate My Closing Costs',
    ctaLabelEs: 'Estimar Mis Costos de Cierre',
    ctaPath: '/v2/buyer-closing-costs',
    secondaryLabelEn: 'Check my buyer readiness',
